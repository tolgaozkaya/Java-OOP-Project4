...
public class MPGKPSPublicSoap
{
    ...
    public MPGKPSPublicSoap(){}

    public MPGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MPGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MPGExtendedSoapSerializationEnvelope envelope= new MPGExtendedSoapSerializationEnvelope(MPGExtendedSoapSerializationEnvelope.VER11);
