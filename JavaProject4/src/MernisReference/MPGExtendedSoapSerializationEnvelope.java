...
public class MPGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MPGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MPGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MPGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MPGDateTimeConverter dateTimeConverter = new MPGStandardDateTimeConverter();

    public MPGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MPGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MPGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MPGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MPGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MPGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
